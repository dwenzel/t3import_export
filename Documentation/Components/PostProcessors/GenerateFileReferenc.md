...
Generates a file reference in `targetField` for the file id found in
`sourceField`. The file reference record is created in `targetPage`.
...
| config.targetPage  | integer | no       | ID of the page in which the file |
